...
export default function DetailBatal(props) {
          ...
          <View key={item.id_jadwal}>
            <View style={styles.wrapperCardAtas}>
              ...
              <View style={styles.Group378}>
                ...
                <View style={styles.Jenis_layanan_kanan}>
                  <Text style={styles.Txt319}>Keterangan</Text>
                  <Text style={styles.Txt656}>{item.cancel_reason !== '' ? item.cancel_reason : '-'}</Text>
                </View>
              </View>
              <View style={styles.Group378}>
                <View style={styles.Jenis_layanan_kiri}>
            ...
            <View style={styles.wrapperCardBawah}>
              ...
              <View style={styles.Jadwal1}>
                <Text style={styles.Txt091}>Keterangan</Text>
                <Text style={styles.Txt710}>{item.cancel_reason !== '' ? item.cancel_reason : '-'}</Text>
              </View>
            </View>
          </View>
        )
              ...
              <View style={styles.User}>
                <View style={styles.Status}>
                  <View style={styles.Frame15}>
                    <Text style={styles.Txt676}>BATAL</Text>
                  </View>
                </View>
              </View>*/}
